 ...
 */
open class Player(private val base: BaseObject = BaseObject(), val playbackEventsToListen : MutableSet<String> = mutableSetOf<String>()) : Fragment(), EventInterface by base {
